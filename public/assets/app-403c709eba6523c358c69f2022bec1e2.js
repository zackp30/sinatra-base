...
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, $b, TMP_1, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $hash2 = $opal.hash2, a = nil, b = nil, text = nil, menu = nil, buttons = nil, menu_thingy = nil, menu_boxes = nil;
  $opal.add_stubs(['$find', '$on', '$==', '$show', '$animate', '$Color', '$jQuery', '$hide']);
  ;
  ;
  a = 0;
  b = 0;
  text = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find(".pls");
  menu = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find(".menu");
  buttons = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find(".menuitems");
  menu_thingy = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find(".click_for_menu");
  menu_boxes = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find(".menubox2, .menubox3, .menubox4");
  return ($a = ($b = menu).$on, $a._p = (TMP_1 = function(){var self = TMP_1._s || this;
  if (b['$=='](0)) {
      buttons.$show("slow");
      menu.$animate($hash2(["height", "width", "backgroundColor"], {"height": 50, "width": 600, "backgroundColor": "" + (self.$jQuery().$Color("orange"))}), 1600);
      buttons.$show("slow");
      menu_thingy.$hide("fast");
      menu_boxes.$show("fast");
      menu_boxes.$animate($hash2(["height", "width"], {"height": "80%", "width": "80%"}), 1600);
      return b = 1;
      } else {
      menu.$animate($hash2(["height", "width", "backgroundColor"], {"height": 20, "width": 50, "backgroundColor": "" + (self.$jQuery().$Color("lightblue"))}), 1600);
      buttons.$hide("slow");
...
//@ sourceMappingURL=/__opal_source_maps__/index.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice;
