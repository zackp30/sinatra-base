...
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, a = nil, b = nil, text = nil, menu = nil, button = nil, menu_thingy = nil, menu_boxes = nil;
  $opal.add_stubs(['$find']);
  ;
  ;
  a = 0;
  ...
  button = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find(".menuitems");
  menu_thingy = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find(".click_for_menu");
  return menu_boxes = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find(".menubox2, .menubox3, .menubox4");
})(Opal);
